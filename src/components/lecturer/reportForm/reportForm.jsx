        ...
        {currentStep === 1 && (
          <div>
            ...
            <div className="report-form-modules-list-container">
              {modules.map((module) => {
                const isChecked = reportData.moduleIds.includes(
                  module.moduleId
                );
                const isDisabled =
                  !isChecked && reportData.moduleIds.length >= 1;
              ...
              <div className="report-form-channel-box" key={channel.channelId}>
                ...
                {selectedChannels.includes(channel.channelId) && (
                  <div>
                    <textarea
                      value={
                        reportData.channelActivities?.[channel.channelId] || ""
                      }
                      onChange={(e) =>
                        updateChannelActivity(channel.channelId, e.target.value)
                      }
            ...
            onClick={() => {
              if (currentStep === 4) {
                ...
                selectedChannels.forEach((id) => {
                  ...
                  if (channel) {
                    channelActivities[channel.channelName] =
                      reportData.channelActivities?.[id] || "";
                  }
                });
