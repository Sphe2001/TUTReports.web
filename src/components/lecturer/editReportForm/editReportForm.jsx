...
import "../../../pages/lecturer/myReport/editReport.css";
            ...
            <div className="report-form-modules-list-container">
              ...
              reportData.modules.length > 0 ? (
                reportData.modules.map((module) => (
                  <label key={module.moduleId || module.moduleCode}>
            ...
            <div className="report-form-upload-container">
              ...
              <div className="report-form-file-input-with-name">
                ...
                {reportData.hasAttendanceRegister &&
                  reportData.attendanceRegisterFile && (
                    <div className="file-selected-container">
                      <div className="report-form-selected-file">
                        <FileText size={16} />
                        <span>{reportData.attendanceRegisterFile}</span>
                        <CheckCircle
                          size={16}
                ...
                {sessionFiles.map((file, i) => (
                  <div className="file-selected-container">
                    <div key={i} className="report-form-selected-file">
                      <FileText size={16} />
                      <span>{file.name}</span>
                      <CheckCircle
                        size={16}
          ...
          <button
            onClick={() => {
              if (currentStep === 4) {
                ...
                Object.keys(selectedChannels).forEach((channelName) => {
                  if (selectedChannels[channelName].show) {
                    channelActivities[channelName] =
                      selectedChannels[channelName].content || "";
                  }
                });

                const previewObject = {
                  moduleCode: reportData.module,
