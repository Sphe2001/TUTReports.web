...
const EditAdminProfilePage = ({ interface: interfaceData = null }) => {
  ...
  }, [interfaceData, fetchAdmin, userId]);
  ...
  return (
    <div className="edit-admin-container">
      ...
      <div className="edit-user-form-layout">
            ...
            <form onSubmit={handleSubmit} className="edit-user-form-body">
              <div className="edit-user-profile-section">
                ...
                <div className="profile-info-section">
                  <h3>{user.adminName + " " + user.adminSurname || "User"}</h3>
        ...
        >
          <ProfileSideInfo user={user} refreshProfile={fetchAdmin} />
        </motion.div>
      </div>
    </div>
  );
